                ...
                <div class="container">
                    ...
                    <div class="row portfolio-container">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item second">
                            <div class="portfolio-wrap">
                                <img src="{{url('/website/img/portfolio-2.jpg')}}" alt="Portfolio Image">
                                <figure>
                                    <p>Politics</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item third">
                            <div class="portfolio-wrap">
                                <img src="{{url('/website/img/portfolio-3.jpg')}}" alt="Portfolio Image">
                                <figure>
                                    <p>Family</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item first">
                            <div class="portfolio-wrap">
                                <img src="{{url('/website/img/portfolio-4.jpg')}}" alt="Portfolio Image">
                                <figure>
                                    <p>Finance</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item second">
                            <div class="portfolio-wrap">
                                <img src="{{url('/website/img/portfolio-5.jpg')}}" alt="Portfolio Image">
                                <figure>
                                    <p>Business</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item third">
                            <div class="portfolio-wrap">
                                <img src="{{url('/website/img/portfolio-6.jpg')}}" alt="Portfolio Image">
                                <figure>
                                    <p>Finance</p>
